...
<body>
    <div class="div1">
        ...
        *kategorie (po kliknięciu rozwija się menu i tutaj są wypisani wszystkie kategorie z bazy, po kolejnym kliknięciu w autora X wyświetlają się wszystkie
        ...
        Aktualizuj zbiory -> href do panelu z aktualizacją i dodawaniem książek (panel z książkami i możliwością aktualizacji
        ręcznej ilości egzemplarzy, dodawaniem nowych pozycji).




        TUTAJ JAKOŚ TRZBA ZROBIĆ EDYCJĘ I DODAWANIE KSIĄŻEK PRZEZ ADMINA, zmiana ilości egzemplarzy, dodanie nowej książki,
        dodanie wydawnictwa, dodanie autora.
